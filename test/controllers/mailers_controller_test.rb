...
class MailersControllerTest < ActionController::TestCase
  ...
  test "should create mailer" do
    assert_difference('Mailer.count') do
      post :create, mailer: { email: @mailer.email, message: @mailer.message, name: @mailer.name, phone: @mailer.phone, zipcode: @mailer.zipcode }
    end
  ...
  test "should update mailer" do
    patch :update, id: @mailer, mailer: { email: @mailer.email, message: @mailer.message, name: @mailer.name, phone: @mailer.phone, zipcode: @mailer.zipcode }
    assert_redirected_to mailer_path(assigns(:mailer))
  end
